package io.github.haodongling.lib.dispatcher.launcher;
...
import io.github.haodongling.lib.dispatcher.launcher.sort.TaskSortUtil;
import io.github.haodongling.lib.dispatcher.launcher.stat.TaskStat;
import io.github.haodongling.lib.dispatcher.launcher.task.DispatchRunnable;
import io.github.haodongling.lib.dispatcher.launcher.task.Task;
import io.github.haodongling.lib.dispatcher.launcher.task.TaskCallBack;
import io.github.haodongling.lib.dispatcher.launcher.utils.DispatcherLog;
...
public class TaskDispatcher {
    ...
    public static void init(Context context) {
        if (context != null) {
            sContext = context;
            sHasInit = true;
            sIsMainProcess = TaskUtils.isMainProcess(sContext);
        }
    }
