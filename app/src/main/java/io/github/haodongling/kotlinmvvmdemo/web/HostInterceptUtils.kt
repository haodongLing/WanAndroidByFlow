...
import io.github.haodongling.lib.common.model.HostEntity
...
object HostInterceptUtils {
    ...
    fun isWhiteHost(host: String?): Boolean {
        val list: List<String> = WHITE_HOST
        for (entity in list) {
            if (TextUtils.equals(entity, host)) {
                return true
            }
        }
        return false
    ...
    fun isBlackHost(host: String?): Boolean {
        val list: List<String> = BLACK_HOST
        for (entity in list) {
            if (TextUtils.equals(entity, host)) {
                return true
            }
    ...
    val BLACK_HOST = listOf<String>(
        "www.taobao.com", "www.jd.com", "yun.tuisnake.com"
    )
}