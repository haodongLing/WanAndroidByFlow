...
import com.haodong.kotlinmvvmdemo.widget.CollectView
import com.haodong.lib.common.model.bean.Article
import com.haodong.lib.common.util.ImageLoader
...
class HomeAdapter(layoutResId: Int) :
    ...
    override fun convert(helper: BaseViewHolder, item: Article) {
        ...
        val cv_collect = helper.getView<CollectView>(R.id.cv_collect)
