...
//        FFLog.d(TAG, "onInterceptTouchEvent:" + child.getTotalScrollRange());
...
//            e.printStackTrace();
    ...
    public boolean onStartNestedScroll(CoordinatorLayout parent, AppBarLayout child, View directTargetChild, View target, int nestedScrollAxes, int type) {
        FFLog.d(TAG, "onStartNestedScroll");
        stopAppbarLayoutFling(child);
...
//        FFLog.d(TAG, "onNestedPreScroll:" + child.getTotalScrollRange() + " ,dx:" + dx + " ,dy:" + dy + " ,type:" + type);
...
//        FFLog.d(TAG, "onNestedScroll: target:" + target.getClass() + " ," + child.getTotalScrollRange() + " ,dxConsumed:" + dxConsumed + " ,dyConsumed:" + dyConsumed + " " + ",type:" + type);
        if (!shouldBlockNestedScroll) {
...
//        FFLog.d(TAG, "onStopNestedScroll");
